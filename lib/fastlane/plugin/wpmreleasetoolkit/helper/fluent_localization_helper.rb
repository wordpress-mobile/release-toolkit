    ...
    class FluentLocalizationHelper
      ...
      def self.fluent_to_po(fluent_file:, fluent_entries:, locale:, project_name:, project_version:)
        ...
        po.add({
                 msgid: '',
                 msgstr: header_lines,
                 translator_comment: "Generated by #{Fastlane::Wpmreleasetoolkit::NAME} (#{Fastlane::Wpmreleasetoolkit::VERSION})"
               })
        ...
        fluent_entries.each do |entry|
          ...
          # Add extracted Fluent comment if present; always using translator comments for simplicity sake
