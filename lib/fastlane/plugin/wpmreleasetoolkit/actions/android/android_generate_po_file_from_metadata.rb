...
module Fastlane
  module Actions
    class AndroidGeneratePoFileFromMetadataAction < Action
      REQUIRED_KEYS = %w[full_description title short_description release_notes_short].freeze
      # TODO: release_notes_previous.txt must be generated by the code_freeze lanes in the Android and Ios repos
