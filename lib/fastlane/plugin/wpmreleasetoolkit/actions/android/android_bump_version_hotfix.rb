  ...
  module Actions
    class AndroidBumpVersionHotfixAction < Action
      ...
      def self.show_config
        UI.message("Current version[#{@flavor}]: #{@current_version[Fastlane::Helper::Android::VersionHelper::VERSION_NAME]}(#{@current_version[Fastlane::Helper::Android::VersionHelper::VERSION_CODE]})")
        UI.message("New hotfix version[#{@flavor}]: #{@new_version[Fastlane::Helper::Android::VersionHelper::VERSION_NAME]}(#{@new_version[Fastlane::Helper::Android::VersionHelper::VERSION_CODE]})")
