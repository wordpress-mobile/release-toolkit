    ...
    context 'with default filter' do
      ...
      describe 'applies content substitutions' do
        ...
        context 'with //string tags' do
          ...
          include_examples 'en-dash substitutions', "/resources/string[@name='threat_fix_description']", '0-1', '0-1', "0\u{2013}1"
          include_examples 'en-dash substitutions', "/resources/string[@name='multi_range_statement']", %w[2-1 3-4], %w[2-1 3-4], ["2\u{2013}1", "3\u{2013}4"]
          include_examples 'en-dash substitutions', "/resources/string[@name='threat_fix_description_large']", '0 - 1', '0 - 1', "0 \u{2013} 1"

          # en-dash: don't substitute negative numbers
          include_examples 'en-dash substitutions', "/resources/string[@name='field_allowed_values']", '1 -1 -2', "1 \u{2013}1 \u{2013}2", '1 -1 -2'

          # en-dash: don't substitute checklists
          include_examples 'en-dash substitutions', "/resources/string[@name='checklist_one']", '- 1.', "\u{2013} 1.", '- 1.'
          include_examples 'en-dash substitutions', "/resources/string[@name='checklist_two']", '- o', "\u{2013} o", '- o'
        end
        ...
        context 'with //string-array/item tags' do
          ...
          # en-dash: substitute ranges
          include_examples 'en-dash substitutions', "/resources/string-array[@name='settings_jetpackdescription']/item[3]", '0-1', '0-1', "0\u{2013}1"
          include_examples 'en-dash substitutions', "/resources/string-array[@name='settings_jetpackdescription_large']/item[3]", '0 - 1', '0 - 1', "0 \u{2013} 1"

          # en-dash: don't substitute negative numbers
          include_examples 'en-dash substitutions', "/resources/string-array[@name='settings_number_series']/item[1]", '1 -1 -2', "1 \u{2013}1 –2", '1 -1 -2'

          # en-dash: don't substitute checklists
          include_examples 'en-dash substitutions', "/resources/string-array[@name='checklist_array']/item[1]", '- 1.', "\u{2013} 1.", '- 1.'
          include_examples 'en-dash substitutions', "/resources/string-array[@name='checklist_array']/item[2]", '- o', "\u{2013} o", '- o'
        end
      end
