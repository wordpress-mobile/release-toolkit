...
describe Fastlane::Helper::Ios::VersionHelper do
  describe 'calculates_the_next_release_version' do
    ...
    context 'when using marketing_versioning' do
      it 'when using marketing_versioning if the minor version number is 9 or less' do
        version = '1.0'
        next_version = described_class.calc_next_release_version(version, 'marketing_versioning')
