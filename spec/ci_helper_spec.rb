...
describe Fastlane::Helper::CircleCIHelper do
  it_behaves_like 'a CI provider' do
    let(:model) { described_class.new(login: 'my_circleci_token', repository: 'test_repo') }
  end

  context 'initialization' do
    describe described_class.new(login: 'my_circleci_token', repository: 'test_repo') do
    ...
    describe described_class.new(login: 'my_circleci_token', repository: 'test_repo', organization: 'my_org') do
